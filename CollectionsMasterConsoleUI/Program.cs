    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine();
            Console.WriteLine($"New Capacity: {numList.Capacity} {numList.Capacity}");
            ...
            } while (isANumber == false);   //(!isANumber)
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            //   if (num == searchNumber)
            //    {
            //        Console.WriteLine($"Yes, {searchNumber} is in on the list");
            //    }
            //   else
            //    {
            //        Console.WriteLine($"No, {searchNumber} is not on the list");
            //    }
            //}
            
            if (numberList.Contains(searchNumber))
            {
                Console.WriteLine($"Yes, {searchNumber} is on the list");
            }
            else
            {
                Console.WriteLine($"No, {searchNumber} is not on the list");
